...
const VerticalNav: FC<userComponent> = (props) => {
  return (
    <div className=" ml-10 col-span-1">
      ...
      <button className=" text-white bg-blue-400 px-20 py-5 rounded-full font-bold  mb-44  text-xl">
        Tweet
      </button>

      <div className=" text-white flex hover:bg-white/25 rounded-full w-[12em]">
